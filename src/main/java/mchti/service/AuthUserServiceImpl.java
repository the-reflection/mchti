...
import mchti.repo.AuthUserRepo;
...
public class AuthUserServiceImpl implements AuthUserService {
    ...
    public List<AuthUser> findAll(_SearchDTO pageable) {
        ...
        //Criteria criteria = getCurrentSession().createCriteria(AuthUser.class);
        //criteria.setFirstResult((pageable.getPage() - 1) * pageable.getPageSize());
        //criteria.setMaxResults(pageable.getPageSize());
        //
        //List<AuthUser> lookups = (List<AuthUser>) criteria.list();
        //
        //int totRecs = 27;
        //
...
//        List<AuthUser> lookups = getCurrentSession().createQuery("FROM " + AuthUser.class.getName() + " m Where m.username='" + username + "'").list();
//
//        if (lookups != null && !lookups.isEmpty()) {
//
//            System.out.println("uuuuuuuu1156: " + lookups.get(0).getUsername() + "::" + lookups.get(0).getPassword());
...
//        user.setCredentialsNonExpired(Boolean.TRUE);
        ...
        for (mchti.model.security.AuthRole authRole : user.getAuthRoles()) {
