...
import mchti.service.EmpService;
...
public class EmpController extends _OithController {
    ...
    String getCodableDTO(@RequestParam(value = "code") String code) {
        ...
        Emp codable = empService.findByCode(code);
    ...
    public String create(ModelMap model) {
        model.addAttribute(MODEL, new Emp());
        return CREATE;
    }

    @RequestMapping(value = "/create", method = RequestMethod.POST)
    public String save(@ModelAttribute(MODEL) @Valid Emp currObject, BindingResult bindingResult, ModelMap model, RedirectAttributes attributes, MultipartHttpServletRequest request) {
    ...
    public String submitEditForm(@ModelAttribute(MODEL) @Valid Emp currObject, BindingResult bindingResult, ModelMap model, RedirectAttributes attributes, MultipartHttpServletRequest request) {
