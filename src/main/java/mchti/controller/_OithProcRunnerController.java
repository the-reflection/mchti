...
@Controller
public class _OithProcRunnerController {
    ...
    @RequestMapping(value = "/procRunner/execNativeQuery", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/procRunner/execOrmQuery", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/procRunner", method = RequestMethod.GET)
    public String getQueryRunnerPage() {
      
        return "etc/procRunnerPage";
    }
}
