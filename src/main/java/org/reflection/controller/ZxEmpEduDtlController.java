...
public class ZxEmpEduDtlController extends _OithController {
    ...
    private void commonPost(ZxEmpEduDtl currObject) {
    ...
    commonPost(currObject);
        ...
        if (!bindingResult.hasErrors()) {
            try {
                ...
                addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_CREATED, zxEmpEduDtl.getId());
    ...
    commonPost(currObject);
        ...
        if (!bindingResult.hasErrors()){
            try {
                ...
                addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_EDITED, zxEmpEduDtl.getId());
                return "redirect:/" + SHOW + "/" + zxEmpEduDtl.getId();
            } catch (Exception e) {
                errorHandler(bindingResult, e);
            }
    ...
    public String copied(@ModelAttribute(MODEL) @Valid ZxEmpEduDtl currObject, BindingResult bindingResult, ModelMap model, RedirectAttributes attributes , MultipartHttpServletRequest request) {
