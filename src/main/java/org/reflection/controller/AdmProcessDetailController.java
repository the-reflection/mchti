...
public class AdmProcessDetailController extends _BaseController {
    ...
    @ModelAttribute("admProcesss")
    public Iterable<AdmProcess> admProcesss() {
        return admProcessService.findAll();
    }
    ...
    private void commonPost(AdmProcessDetail currObject) {
            try {
                currObject.setAdmProcess(admProcessService.findById(currObject.getAdmProcess().getId()));
            } catch (Exception e) {
