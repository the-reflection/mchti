...
@Controller
@RequestMapping(value = "/procRunner")
public class _OithProcRunnerController {
    ...
    @RequestMapping(value = "/execNativeQuery", method = RequestMethod.POST)
    public @ResponseBody
    ...
    @RequestMapping(value = "/execOrmQuery", method = RequestMethod.POST)
    public @ResponseBody
