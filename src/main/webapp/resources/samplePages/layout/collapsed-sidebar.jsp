<%-- 
    Document   : collapsed-sidebar
    Created on : May 22, 2016, 1:34:32 PM
...
<html>
    <head>
        ...
        <title>Reflection | Collapsed Sidebar Layout</title>
    ...
    <body class="hold-transition skin-blue sidebar-collapse sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="../home/index2.jsp" class="logo">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../home/index.jsp"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                                <li><a href="../home/index2.jsp"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                            </ul>
                        </li>
