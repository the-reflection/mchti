<%-- 
    Document   : widgets
    Created on : May 22, 2016, 1:38:25 PM
...
<html>
    <head>
        ...
        <title>Reflection | Widgets</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="../samplePages/home/index2.jsp" class="logo">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini"><b>R</b>IT</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Reflection</b>IT LTD</span>
                </a>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../samplePages/home/index.jsp"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                                <li><a href="../samplePages/home/index2.jsp"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-info clearfix">
                                                <span class="direct-chat-name pull-left">Md. Badiuzzaman</span>
                            ...
                            <div class="box box-success direct-chat direct-chat-success">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-info clearfix">
                                                <span class="direct-chat-name pull-left">Saif Khan</span>
                                                <span class="direct-chat-timestamp pull-right">23 Jan 2:00 pm</span>
                                            </div>
                                            <!-- /.direct-chat-info -->
                    ...
                    <div class="row">
                            ...
                            <div class="box box-widget widget-user-2">
                                ...
                                <div class="widget-user-header bg-yellow">
                                    <div class="widget-user-image">
                                        <img class="img-circle" src="../images/user_images/badiuzzaman.jpg" alt="User Avatar">
                                    </div>
                                    <!-- /.widget-user-image -->
                                    <h3 class="widget-user-username">Md. Badiuzzaman</h3>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-widget widget-user">
                                ...
                                <div class="widget-user-header bg-aqua-active">
                                    <h3 class="widget-user-username">Md. Anisur Rahman</h3>
                                    <h5 class="widget-user-desc">Founder &amp; CEO</h5>
                                </div>
                                <div class="widget-user-image">
                                    <img class="img-circle" src="../images/user_images/anisur_rahman.jpg" alt="User Avatar">
                                </div>
                                <div class="box-footer">
                                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-widget widget-user">
                                ...
                                <div class="widget-user-image">
                                    <img class="img-circle" src="../images/user_images/saif_khan.jpg" alt="User Avatar">
                                </div>
                                <div class="box-footer">
                                    <div class="row">
                                        <div class="col-sm-4 border-right">
                    ...
                    <div class="row">
                            ...
                            <div class="box box-widget">
                                <div class="box-header with-border">
                                    <div class="user-block">
                                        <img class="img-circle" src="../images/user_images/saif_khan.jpg" alt="User Image">
                                        <span class="username"><a href="#">Saif Khan</a></span>
                                ...
                                <div class="box-footer box-comments">
                                    <div class="box-comment">
                                        ...
                                        <div class="comment-text">
                                            ...
                                            It is a long established fact that a reader will be frameworks/admin-lte-2.3.3racted
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-widget">
                                <div class="box-header with-border">
                                    <div class="user-block">
                                        <img class="img-circle" src="../images/user_images/anisur_rahman.jpg" alt="User Image">
                                        <span class="username"><a href="#">Md. Anisur Rahman Khan</a></span>
                                        <span class="description">Shared publicly - 7:30 PM Today</span>
                                    </div>
                                    <!-- /.user-block -->
                                    <div class="box-tools">
                                ...
                                <div class="box-footer box-comments">
                                    ...
                                    <div class="box-comment">
                                        ...
                                        <div class="comment-text">
                                            ...
                                            normal frameworks/admin-lte-2.3.3ribution of letters, as opposed to using
