<%-- 
    Document   : mailbox
    Created on : May 22, 2016, 1:36:13 PM
...
<html>
    <head>
        ...
        <title>Reflection | Mailbox</title>
        ...
        <!-- fullCalendar 2.2.5-->
        <link rel="stylesheet" href="../../frameworks/fullcalendar/fullcalendar.min.css">
        <link rel="stylesheet" href="../../frameworks/fullcalendar/fullcalendar.print.css" media="print">
        <!-- Theme style -->
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="mailbox.jsp">Inbox <span class="label label-primary pull-right">13</span></a>
                                </li>
                                        ...
                                        <table class="table table-hover table-striped">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="mailbox-name"><a href="read-mail.jsp">Saif Khan</a></td>
                                                    <td class="mailbox-subject"><b>Reflection.0 Issue</b> - Trying to find a solution to this problem...
                                                    </td>
