<%-- 
    Document   : index
    Created on : May 22, 2016, 1:30:54 PM
...
<html>
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="../../frameworks/iCheck/flat/blue.css">
        <!-- Morris chart -->
        <link rel="stylesheet" href="../../frameworks/morris/morris.css">
        <!-- jvectormap -->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li><!-- start message -->
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="../../images/user_images/saif_khan.jpg" class="img-circle" alt="saif_khan">
                                                    </div>
                                                    <h4>
                                                        Support Team
                        ...
                        <section class="col-lg-7 connectedSortable">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="../../images/user_images/saif_khan.jpg" alt="user image" class="online">

                                        <p class="message">
                                            <a href="https://www.facebook.com/saif.hmk" target="_blank" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="../../images/user_images/anisur_rahman.jpg" alt="user image" class="offline">

                                        <p class="message">
                                            <a href="https://www.facebook.com/akash.babu.359" target="_blank" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="../../images/user_images/badiuzzaman.jpg" alt="user image" class="offline">

                                        <p class="message">
                                            <a href="https://www.facebook.com/mohammad.badiuzzaman" target="_blank" class="name">
        ...
        <script src="../../frameworks/morris/morris.min.js"></script>
        <!-- Sparkline -->
        ...
        <!-- jQuery Knob Chart -->
        <script src="../../frameworks/knob/jquery.knob.js"></script>
        <!-- daterangepicker -->
        ...
        <script src="../../frameworks/admin-lte-2.3.3/js/pages/dashboard.js"></script>
