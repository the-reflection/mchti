<%-- 
    Document   : sliders
    Created on : May 22, 2016, 1:41:04 PM
...
<html>
    <head>
        ...
        <title>Reflection | UI Sliders</title>
        ...
        <!-- Ion Slider -->
        <link rel="stylesheet" href="../../frameworks/ionslider/ion.rangeSlider.css">
        <!-- ion slider Nice -->
        <link rel="stylesheet" href="../../frameworks/ionslider/ion.rangeSlider.skinNice.css">
        <!-- bootstrap slider -->
        <link rel="stylesheet" href="../../frameworks/bootstrap-slider/slider.css">
        <!-- Theme style -->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="general.jsp"><i class="fa fa-circle-o"></i> General</a></li>
                                <li><a href="icons.jsp"><i class="fa fa-circle-o"></i> Icons</a></li>
                                <li><a href="buttons.jsp"><i class="fa fa-circle-o"></i> Buttons</a></li>
                                <li class="active"><a href="sliders.jsp"><i class="fa fa-circle-o"></i> Sliders</a></li>
                                <li><a href="timeline.jsp"><i class="fa fa-circle-o"></i> Timeline</a></li>
                                <li><a href="modals.jsp"><i class="fa fa-circle-o"></i> Modals</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
        ...
        <!-- Ion Slider -->
        <script src="../../frameworks/ionslider/ion.rangeSlider.min.js"></script>
        <!-- Bootstrap slider -->
        <script src="../../frameworks/bootstrap-slider/bootstrap-slider.js"></script>
        <script>
            $(function () {
                /* BOOTSTRAP SLIDER */
                $('.slider').slider();
