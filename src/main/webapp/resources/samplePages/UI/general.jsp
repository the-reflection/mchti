<%-- 
    Document   : general
    Created on : May 22, 2016, 1:40:04 PM
...
<html>
    <head>
        ...
        <title>Reflection | General UI</title>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="general.jsp"><i class="fa fa-circle-o"></i> General</a></li>
                                <li><a href="icons.jsp"><i class="fa fa-circle-o"></i> Icons</a></li>
                                <li><a href="buttons.jsp"><i class="fa fa-circle-o"></i> Buttons</a></li>
                                <li><a href="sliders.jsp"><i class="fa fa-circle-o"></i> Sliders</a></li>
