<%-- 
    Document   : register
    Created on : May 22, 2016, 1:47:07 PM
...
<html>
    <head>
        ...
        <title>Reflection | Registration Page</title>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="../../frameworks/iCheck/square/blue.css">
        <link rel="stylesheet" href="../../frameworks/iCheck/square/blue.css">
    ...
    <body class="hold-transition register-page">
        <div class="register-box">
            ...
            <div class="register-box-body">
                ...
                <form action="../../samplePages/home/index.jsp" method="post">
