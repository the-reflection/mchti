                                        ...
                                        <div class="post">
                                            ...
                                            <div class="row margin-bottom">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <img class="img-responsive" src="../../plugins/admin-lte-2.3.3/img/photo2.png" alt="Photo">
                                                            <br>
                                                            <img class="img-responsive" src="../../images/user_images/photo_2.jpg" alt="Photo">
                                                        </div>
                                                        <!-- /.col -->
                                                        <div class="col-sm-6">
                                                            <img class="img-responsive" src="../../plugins/admin-lte-2.3.3/img/photo4.jpg" alt="Photo">
                                                            <br>
                                                            <img class="img-responsive" src="../../plugins/admin-lte-2.3.3/img/photo1.png" alt="Photo">
                                                        </div>
                                                        <!-- /.col -->
                                                    </div>
                                                    <!-- /.row -->
