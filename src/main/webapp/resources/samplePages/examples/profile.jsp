<%-- 
    Document   : profile
    Created on : May 22, 2016, 1:46:50 PM
...
<html>
    <head>
        ...
        <title>Reflection | User Profile</title>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    <img class="profile-user-img img-responsive img-circle" src="../../images/user_images/saif_khan.jpg" alt="User profile picture">

                                    <h3 class="profile-username text-center"><a href="https://www.facebook.com/saif.hmk" target="_blank">Saif Khan</a></h3>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <p>
                                        ...
                                        <span class="label label-info">Java Script</span>
                                    ...
                                    <div class="active tab-pane" id="activity">
                                        ...
                                        <div class="post">
                                            <div class="user-block">
                                                <img class="img-circle img-bordered-sm" src="../../images/user_images/badiuzzaman.jpg" alt="user image">
                                                <span class="username">
                                                    <a href="https://www.facebook.com/mohammad.badiuzzaman" target="_blank">Md. Badiuzzaman Manik</a>
                                        ...
                                        <div class="post clearfix">
                                            <div class="user-block">
                                                <img class="img-circle img-bordered-sm" src="../../images/user_images/anisur_rahman.jpg" alt="User Image">
                                                <span class="username">
                                                    <a href="https://www.facebook.com/akash.babu.359" target="_blank">Md. Anisur Rahman</a>
                                                    <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                                                </span>
                                        ...
                                        <div class="post">
                                            <div class="user-block">
                                                <img class="img-circle img-bordered-sm" src="../../images/user_images/asif_mahmud.jpg" alt="Asif Mahmud">
                                                <span class="username">
                                                    <a href="https://www.facebook.com/CSE.Asif" target="_blank">Asif Mahmud</a>
                                                    <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                                                </span>
                                            ...
                                            <div class="row margin-bottom">
                                                <div class="col-sm-6">
                                                    <img class="img-responsive" src="../../images/user_images/photo_1.jpg" alt="Photo">
                                                </div>
                                                <!-- /.col -->
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <img class="img-responsive" src="../../frameworks/admin-lte-2.3.3/img/photo2.png" alt="Photo">
                                                            <br>
                                                            <img class="img-responsive" src="../../images/user_images/photo_2.jpg" alt="Photo">
                                                        </div>
                                                        <!-- /.col -->
                                                        <div class="col-sm-6">
                                                            <img class="img-responsive" src="../../frameworks/admin-lte-2.3.3/img/photo4.jpg" alt="Photo">
                                                            <br>
                                                            <img class="img-responsive" src="../../frameworks/admin-lte-2.3.3/img/photo1.png" alt="Photo">
                                                        </div>
                                                        <!-- /.col -->
                                                    </div>
                                                    <!-- /.row -->
