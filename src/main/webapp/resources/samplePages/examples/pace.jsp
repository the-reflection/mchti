<%-- 
    Document   : pace
    Created on : May 22, 2016, 1:46:33 PM
...
<html>
    <head>
        ...
        <title>Reflection | Pace Page</title>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="pace.jsp"><i class="fa fa-circle-o"></i> Pace Page</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
        ...
        <script type="text/javascript">
            ...
            $('.ajax').click(function () {
                $.ajax({url: '#', success: function (result) {
                        $('.ajax-content').jsp('<hr>Ajax Request Completed !');
                    }});
            });
        </script>
    </body>
