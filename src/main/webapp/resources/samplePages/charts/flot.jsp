<%-- 
    Document   : flot
    Created on : May 22, 2016, 1:42:13 PM
...
<html>
    <head>
        ...
        <title>Reflection | Flot Charts</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <!-- FLOT CHARTS -->
        <script src="../../frameworks/flot/jquery.flot.min.js"></script>
        <!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
        <script src="../../frameworks/flot/jquery.flot.resize.min.js"></script>
        <!-- FLOT PIE PLUGIN - also used to draw donut charts -->
        <script src="../../frameworks/flot/jquery.flot.pie.min.js"></script>
        <!-- FLOT CATEGORIES PLUGIN - Used to draw bar charts -->
        <script src="../../frameworks/flot/jquery.flot.categories.min.js"></script>
        <!-- Page script -->
        <script>
            $(function () {
                /*
                ...
                $("#line-chart").bind("plothover", function (event, pos, item) {
                    ...
                    if (item) {
                        ...
                        $("#line-chart-tooltip").jsp(item.series.label + " of " + x + " = " + y)
