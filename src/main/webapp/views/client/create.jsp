    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> Client</h1>
                <ul class='top-links'>
                    <sec:access url='/client/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/client/index' class='btn btn-block btn-vimeo btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-client' class='box box-primary' role='main'>
                    <form:form action='${pageContext.request.contextPath}/client/create' enctype='multipart/form-data' commandName='client' method='POST'>
                        <div class='box-body'>
