...
<div>  
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:input class='form-control' path='urlPath' type='text' required='true' size='30' maxlength='255'/>
    ...
    <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
        <div class='form-group'>
            ...
            <form:input class='form-control' path='displayIconClass' type='text' size='30' maxlength='128'/>
