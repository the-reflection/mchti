                        ...
                        <td><c:out value='${zxEmpEduDtl.zxEmpWhoCheckedBy!=null ? zxEmpEduDtl.zxEmpWhoCheckedBy :"N/A"}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/zxEmpEduDtl/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/zxEmpEduDtl/delete/${zxEmpEduDtl.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
