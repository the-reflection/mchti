    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> Zx Emp Edu Dtl</h1>
                <ul class='top-links'>
                    <sec:access url='/zxEmpEduDtl/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/zxEmpEduDtl/index' class='btn btn-block btn-vimeo btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-zxEmpEduDtl' class='box box-primary' role='main'>
