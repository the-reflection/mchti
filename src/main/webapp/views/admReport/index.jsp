                        ...
                        <td><c:out value='${admReport.remarks}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/admReport/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/admReport/delete/${admReport.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
