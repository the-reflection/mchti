    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.list.label' text='List'/> Auth Question</h1>
                <ul class='top-links'>
                ...
                <div class='box box-primary'>   
                    <div class='box-body' style='overflow-x: auto'>
                        <table class='dt-default table table-bordered table-striped table-hover table-condensed'>
                            ...
                            <thead>
                        <th class='center bold'><spring:message code='question' text='Question'/></th>
                    ...
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        <td><c:out value='${authQuestion.question}'/></td>
                           ...
                           <td class='center action'>
                            <ul class='top-links'>
                            <sec:access url='/authQuestion/show'>
                                <li>
                                <a class='btn btn-block btn-info btn-xs' href='${pageContext.request.contextPath}/authQuestion/show/${authQuestion.id}'>
                                    <i class='fa fa-info-circle'></i> <spring:message code='show.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/authQuestion/edit'>
                                <li>
                                <a class='btn btn-block btn-primary btn-xs' href='${pageContext.request.contextPath}/authQuestion/edit/${authQuestion.id}'>
                            ...
                            <sec:access url='/authQuestion/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/authQuestion/delete/${authQuestion.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
