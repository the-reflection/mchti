                        ...
                        <td><c:out value='${authQuestion.question}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/authQuestion/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/authQuestion/delete/${authQuestion.id}' onclick='return confirm('Are you sure to delete?');'>
