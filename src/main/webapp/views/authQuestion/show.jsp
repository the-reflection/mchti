    ...
    <tiles:putAttribute name="body">
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            <section class="content-header"><!-- Content Header (Page header) -->
                <h1><spring:message code="default.button.show.label" text="Show"/> AuthQuestion</h1>
                <ul class="top-links">
        ...
        <div><jsp:include page="authUserAuthQuestions.jsp" /></div>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/authQuestion/copy/${authQuestion.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="copy.link.label"/></a>             
