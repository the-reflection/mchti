    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.copy.label' text='Copy'/> Auth User</h1>
                <ul class='top-links'>
                    <ul class='top-links'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${pageContext.request.contextPath}/authUser/copy' enctype='multipart/form-data' commandName='authUser' method='POST'>
                        <div class='box-body'>
