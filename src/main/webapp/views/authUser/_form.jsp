...
<div>
    <div class="row">
        ...
        <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3'>
            <div class='form-group'>
                ...
                <form:input class='form-control' path='password' type='text' required='true' size='30' maxlength='128'/>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
            <div class='form-group'>
                ...
                <img height="100px" width="100px" alt='${authUser.picFile}' src='${picFile}'/>
    ...
    <div class='no-padding col-xs-12 col-sm-6 col-md-6 col-lg-6'>
