    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> Auth User</h1>
                <ul class='top-links'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-authUser' class='box box-primary' role='main'>
                    <form:form action='${pageContext.request.contextPath}/authUser/create' enctype='multipart/form-data' commandName='authUser' method='POST'>
                        <div class='box-body'>
