            ...
            <c:if test="${not empty authUsers}">
                <c:forEach items="${authUsers}" var="authUser"  varStatus="loopStatus">
                    <tr class="${loopStatus.index % 2 == 0 ? 'odd' : 'even'}">
                        ...
                        <td><c:out value="${authUser.accountNonLocked}"/></td>
                        <td><c:out value="${authUser.credentialsNonExpired}"/></td>
                        <td><c:out value="${authUser.enabled}"/></td>
                        ...
                        <td><c:out value="${authUser.picFile}"/></td>
                        <td><c:out value="${authUser.username}"/></td>
