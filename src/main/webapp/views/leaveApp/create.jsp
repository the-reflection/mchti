    ...
    <tiles:putAttribute name="body">
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            <section class="content-header"><!-- Content Header (Page header) -->
                <h1><spring:message code="default.button.create.label" text="Create"/> Leave App</h1>
                <ul class="top-links">
                    <sec:access url="/leaveApp/index">
                        <li>
                            <a href="${pageContext.request.contextPath}/leaveApp/index" class="btn btn-block btn-vimeo btn-xs">
            ...
            <section class="content"><!-- Main content -->
                <div id="create-leaveApp" class="box box-primary" role="main">
                    <form:form action="${pageContext.request.contextPath}/leaveApp/create"  commandName="leaveApp" method="POST">
                        <div class="box-body">
