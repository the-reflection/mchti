                ...
                <span class="property-value" aria-labelledby="reasonForLeave">
                    <c:out value="${leaveApp.reasonForLeave}"/>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/leaveApp/copy/${leaveApp.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="default.button.copy.label"/></a>             
