    ...
    <div class="box-body">
        <tiles:putAttribute name="body">
            ...
            <div class="box box-primary">
                ...
                <form:form action="${pageContext.request.contextPath}/lookup/copy/${lookup.id}" commandName="lookup" method="POST">
                    ...
                    <div class="box-footer">
                        ...
                        <div class="btn-group">
                            <a class="btn btn-info" href="${pageContext.request.contextPath}/lookup/show/${lookup.id}"><spring:message code="show.link.label"/></a>
                            <button type="submit" class="btn btn-warning" ><spring:message code="copy.page.submit.label"/></button>
                        </div>
                    </div>
                </form:form>
            </div>
