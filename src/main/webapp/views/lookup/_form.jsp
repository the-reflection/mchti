...
<div>   
    ...
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <div class="form-group">
            <form:label class="required" path="keyword"><spring:message code="keyword" text="Keyword"/></form:label>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="form-group">
            <form:label path="titleBng"><spring:message code="titleBng" text="Bangla Title"/></form:label>
            <form:textarea path="titleBng" class="form-control" type="text" size="30" maxlength="500"/>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="form-group">
            <form:label class="required" path="remarks"><spring:message code="remarks" text="Remarks"/></form:label>
