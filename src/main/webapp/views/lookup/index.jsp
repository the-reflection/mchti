        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>   
                    ...
                    <th class='center bold'><spring:message code='keyword' text='Keyword'/></th>
                        ...
                        <td><c:out value='${lookup.keyword}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/lookup/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/lookup/delete/${lookup.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
