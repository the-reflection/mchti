                ...
                <div class="row">
                    <div class="col-sm-4 wow fadeInLeft">
                        <div class="team-member">
                            <img src="${pageContext.request.contextPath}/resources/site/img/landing/avatar3.jpg" class="img-responsive img-circle img-small" alt="">
                    ...
                    <div class="col-sm-4">
                        <div class="team-member wow zoomIn">
                            <img src="${pageContext.request.contextPath}/resources/site/img/landing/avatar1.jpg" class="img-responsive img-circle" alt="">
                    ...
                    <div class="col-sm-4 wow fadeInRight">
                        <div class="team-member">
                            <img src="${pageContext.request.contextPath}/resources/site/img/landing/avatar2.jpg" class="img-responsive img-circle img-small" alt="">
