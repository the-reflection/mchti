                        ...
                        <td><fmt:formatDate value='${authToken.lastUsed}' type='date' pattern='dd/MM/yyyy'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/authToken/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/authToken/delete/${authToken.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
