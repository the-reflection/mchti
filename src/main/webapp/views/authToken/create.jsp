    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> Auth Token</h1>
                <ul class='top-links'>
                    <sec:access url='/authToken/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/authToken/index' class='btn btn-block btn-vimeo btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-authToken' class='box box-primary' role='main'>
                    <form:form action='${pageContext.request.contextPath}/authToken/create'  commandName='authToken' method='POST'>
                        <div class='box-body'>
