      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../../samplePages/home/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="../../samplePages/home/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <div class="error-page">
        ...
        <div class="error-content">
          ...
          <p>
            ...
            Meanwhile, you may <a href="../../samplePages/home/index.html">return to dashboard</a> or try using the search form.
          </p>
