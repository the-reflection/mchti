...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="<%=request.getContextPath()%>/homeSecure" class="logo">
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="<%=request.getContextPath()%>/resources/images/user_images/saif_khan.jpg" class="img-circle" alt="User Image">
                                        </div>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                <!--{fullName} {empty email ? '' : '<br>'.concat(email)}--> 
                                ${fullName} 
                                ${email} 
