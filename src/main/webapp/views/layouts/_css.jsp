...
<!-- daterange picker -->
<link rel='stylesheet' href='<%=request.getContextPath()%>/resources/plugins/daterangepicker/daterangepicker-bs3.css'>
...
<link rel='stylesheet' type='text/css' href='<%=request.getContextPath()%>/resources/jquery-confirm/jquery-confirm.min.css'>
