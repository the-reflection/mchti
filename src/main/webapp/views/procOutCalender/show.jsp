                ...
                <span class="property-value" aria-labelledby="remarks">
                    <c:out value="${procOutCalender.remarks}"/>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/procOutCalender/copy/${procOutCalender.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="copy.link.label"/></a>             
