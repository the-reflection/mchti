    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> Supplier</h1>
                <ul class='top-links'>
                    <sec:access url='/supplier/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/supplier/index' class='btn btn-block btn-vimeo btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-supplier' class='box box-primary' role='main'>
                    <form:form action='${pageContext.request.contextPath}/supplier/create' enctype='multipart/form-data' commandName='supplier' method='POST'>
                        <div class='box-body'>
