                        ...
                        <td><c:out value='${supplier.address}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/supplier/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/supplier/delete/${supplier.id}' onclick='return confirm('Are you sure to delete?');'>
