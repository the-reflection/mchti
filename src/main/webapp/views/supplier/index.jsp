...
<tiles:insertDefinition name='main' >
    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.list.label' text='List'/> Supplier</h1>
                <ul class='top-links'>
    ...
    <th class='center bold'><spring:message code='default.button.action.label' text='Action'/></th> 
            ...
            <c:if test='${not empty suppliers}'>
                <c:forEach items='${suppliers}' var='supplier'  varStatus='loopStatus'>
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        <td><c:out value='${supplier.code}'/></td>
                        <td><c:url var='picFile' value='/supplier/getPhotoTumb/${supplier.picFile}'/>
<img alt='${supplier.picFile}' src='${picFile}'/></td>
                        <td><c:out value='${supplier.fullName}'/></td>
                        <td><c:out value='${supplier.gender}'/></td>
                        <td><fmt:formatDate value='${supplier.dob}' type='date' pattern='dd/MM/yyyy'/></td>
                        ...
                        <td><c:out value='${supplier.address}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/supplier/show'>
                                <li>
                                <a class='btn btn-block btn-info btn-xs' href='${pageContext.request.contextPath}/supplier/show/${supplier.id}'>
                                    <i class='fa fa-info-circle'></i> <spring:message code='show.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/supplier/edit'>
                                <li>
                                <a class='btn btn-block btn-primary btn-xs' href='${pageContext.request.contextPath}/supplier/edit/${supplier.id}'>
                                    <i class='fa fa-edit'></i> <spring:message code='edit.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/supplier/copy'>
                                <li>
                                <a class='btn btn-block btn-warning btn-xs' href='${pageContext.request.contextPath}/supplier/copy/${supplier.id}'>
                            ...
                            <sec:access url='/supplier/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/supplier/delete/${supplier.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
