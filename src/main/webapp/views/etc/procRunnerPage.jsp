...
<tiles:putAttribute name="body">
    ...
    <title><spring:message code="processRunnerPage.title" text="Process Runner Page"/></title>
    ...
    <table>
        <tr>
            ...
            <td>   
                <textarea id="query" rows="4" cols="50">SELECT m.code, m.title FROM Emp m</textarea>
            </td>
            <td>
