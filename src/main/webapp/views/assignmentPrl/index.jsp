                        ...
                        <td><c:out value='${assignmentPrl.gross}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/assignmentPrl/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/assignmentPrl/delete/${assignmentPrl.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
