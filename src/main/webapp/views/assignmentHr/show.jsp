    ...
    <tiles:putAttribute name="body">
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            <section class="content-header"><!-- Content Header (Page header) -->
                <h1><spring:message code="default.button.show.label" text="Show"/> AssignmentHr</h1>
                <ul class="top-links">
                ...
                <span class="property-value" aria-labelledby="empGroup">
                    <c:out value="${assignmentHr.empGroup}"/>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/assignmentHr/copy/${assignmentHr.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="copy.link.label"/></a>             
