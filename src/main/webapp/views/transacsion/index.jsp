                        ...
                        <td><c:out value='${transacsion.remarks}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/transacsion/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/transacsion/delete/${transacsion.id}' onclick='return confirm('Are you sure to delete?');'>
