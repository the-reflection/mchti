    ...
    <tiles:putAttribute name="body">
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            <section class="content-header"><!-- Content Header (Page header) -->
                <h1><spring:message code="default.button.list.label" text="List"/> Department</h1>
                <ul class="top-links">
                        ...
                        <td><c:out value="${department.slNo}"/></td>
                           ...
                           <td class="center action">
                            ...
                            <sec:access url="/department/delete">
                                <li>
                                <a class="btn btn-block btn-danger btn-xs" href="${pageContext.request.contextPath}/department/delete/${department.id}" onclick="return confirm('Are you sure to delete?');">
