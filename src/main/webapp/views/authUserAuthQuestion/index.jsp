                        ...
                        <td><c:out value='${authUserAuthQuestion.answer}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/authUserAuthQuestion/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/authUserAuthQuestion/delete/${authUserAuthQuestion.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
