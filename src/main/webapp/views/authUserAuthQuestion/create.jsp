    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> Auth User Auth Question</h1>
                <ul class='top-links'>
                    <sec:access url='/authUserAuthQuestion/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/authUserAuthQuestion/index' class='btn btn-block btn-vimeo btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-authUserAuthQuestion' class='box box-primary' role='main'>
                    <form:form action='${pageContext.request.contextPath}/authUserAuthQuestion/create'  commandName='authUserAuthQuestion' method='POST'>
                        <div class='box-body'>
                        ...
                        </div><!-- /.create-authUserAuthQuestion -->
                    </section><!-- /.content -->
                </div><!-- /.content-wrapper -->
            </tiles:putAttribute>
