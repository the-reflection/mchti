                ...
                <span class="property-value" aria-labelledby="answer">
                    <c:out value="${authUserAuthQuestion.answer}"/>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/authUserAuthQuestion/copy/${authUserAuthQuestion.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="copy.link.label"/></a>             
