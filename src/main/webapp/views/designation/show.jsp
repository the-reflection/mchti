                ...
                <span class="property-value" aria-labelledby="slNo">
                    <c:out value="${designation.slNo}"/>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/designation/copy/${designation.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="copy.link.label"/></a>             
