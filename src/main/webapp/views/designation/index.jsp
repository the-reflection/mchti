                        ...
                        <td><c:out value='${designation.slNo}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/designation/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/designation/delete/${designation.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
