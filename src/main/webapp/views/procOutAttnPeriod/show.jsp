                ...
                <span class="property-value" aria-labelledby="dayHoliday">
                    <c:out value="${procOutAttnPeriod.dayHoliday}"/>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/procOutAttnPeriod/copy/${procOutAttnPeriod.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="copy.link.label"/></a>             
