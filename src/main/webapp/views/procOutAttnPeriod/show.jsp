    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.show.label' text='Show'/> Proc Out Attn Period</h1>
                <ul class='top-links'>
                ...
                <span class='property-value' aria-labelledby='dayHoliday'>
                    <c:out value='${procOutAttnPeriod.dayHoliday}'/>
                        ...
                        <div class='box-footer'>
                            ...
                            <a href='${pageContext.request.contextPath}/procOutAttnPeriod/copy/${procOutAttnPeriod.id}' class='btn btn-warning' onclick="return alert('Unique field should not contain same value...!');"><i class='fa fa-clone'></i> <spring:message code='default.button.copy.label'/></a>             
                            <a href='${pageContext.request.contextPath}/procOutAttnPeriod/delete/${procOutAttnPeriod.id}' class='btn btn-danger pull-right' onclick="return confirm('Are you sure...? you want to delete this record...!');"><i class='fa fa-remove'></i> <spring:message code='delete.link.label'/></a>
                        </div>      <!--.box-footer-->
                    </div>      <!--.box .box-primary-->
                </section>      <!--.content-->
            </div>      <!--.content-wrapper-->
