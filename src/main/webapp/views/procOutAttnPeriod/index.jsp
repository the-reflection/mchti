                        ...
                        <td><c:out value='${procOutAttnPeriod.dayHoliday}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/procOutAttnPeriod/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/procOutAttnPeriod/delete/${procOutAttnPeriod.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
