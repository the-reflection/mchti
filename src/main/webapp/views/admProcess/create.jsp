    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> Adm Process</h1>
                <ul class='top-links'>
                    <sec:access url='/admProcess/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/admProcess/index' class='btn btn-block btn-vimeo btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-admProcess' class='box box-primary' role='main'>
