                                                ...
                                                <td class='center action'>
                                                    <ul class='top-links'>
                                                        ...
                                                        <sec:access url='/admProcess/delete'>
                                                            <li>
                                                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/admProcess/delete/${admProcess.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
