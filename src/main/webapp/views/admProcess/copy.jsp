    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.copy.label' text='Copy'/> Adm Process</h1>
                <ul class='top-links'>
                    <ul class='top-links'>
                        <sec:access url='/admProcess/create'>
                            <li>
                                <a href='${pageContext.request.contextPath}/admProcess/create' class='btn btn-block btn-primary btn-xs'>
                        ...
                        <sec:access url='/admProcess/index'>
                            <li>
                                <a href='${pageContext.request.contextPath}/admProcess/index' class='btn btn-block btn-info btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>
                    <form:form action='${pageContext.request.contextPath}/admProcess/copy'  commandName='admProcess' method='POST'>
                        <div class='box-body'>
