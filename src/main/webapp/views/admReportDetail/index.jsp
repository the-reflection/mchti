            ...
            <c:if test='${not empty admReportDetails}'>
                <c:forEach items='${admReportDetails}' var='admReportDetail'  varStatus='loopStatus'>
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        ...
                        <td><c:out value='${admReportDetail.admReport}'/></td>
                        <td><c:out value='${admReportDetail.admParam}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/admReportDetail/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/admReportDetail/delete/${admReportDetail.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
