                ...
                <span class="property-value" aria-labelledby="remarks">
                    <c:out value="${procOutAttnDt.remarks}"/>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/procOutAttnDt/copy/${procOutAttnDt.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="default.button.copy.label"/></a>             
