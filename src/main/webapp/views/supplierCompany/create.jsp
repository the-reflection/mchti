    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> Supplier Company</h1>
                <ul class='top-links'>
                    <sec:access url='/supplierCompany/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/supplierCompany/index' class='btn btn-block btn-vimeo btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-supplierCompany' class='box box-primary' role='main'>
                    <form:form action='${pageContext.request.contextPath}/supplierCompany/create' enctype='multipart/form-data' commandName='supplierCompany' method='POST'>
                        <div class='box-body'>
