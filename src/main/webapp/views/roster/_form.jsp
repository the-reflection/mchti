...
<div>  
    ...
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
        <div class="form-group">
            <form:label path="formula"><spring:message code="formula" text="Formula"/></form:label>
            <form:textarea class="form-control" path="formula" type="text" size="30" maxlength="500"/>
            <form:errors path="formula" cssClass="error" element="div"/>
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
        <div class="form-group">
