                ...
                <span class="property-value" aria-labelledby="slNo">
                    <c:out value="${roster.slNo}"/>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/roster/copy/${roster.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="copy.link.label"/></a>             
