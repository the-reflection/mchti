        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>   
                    ...
                    <th class='center bold'><spring:message code='formula' text='Formula'/></th>
                        ...
                        <td><c:out value='${roster.slNo}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/roster/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/roster/delete/${roster.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
