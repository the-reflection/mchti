                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <sec:authorize access='isAuthenticated()'>
                                <li>
                                    <a class="page-scroll" href="${pageContext.request.contextPath}/logout" onclick="prompt('Are you sure...?')">Logout</a>
                                </li>
                            </sec:authorize>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="comments-avatar">
                            <a href="#" class="pull-left">
                                <img alt="image" src="${pageContext.request.contextPath}/resources/images/user_images/shafiqul_islam.jpg">
                            </a>
