...
<a target='_blank' href='${docFile}'>${zxEmp.docFile}</a>
    ...
    <div><jsp:include page='zxEmpEduDtls.jsp' /></div>
                        ...
                        <div class='box-footer'>
                            ...
                            <a href='${pageContext.request.contextPath}/zxEmp/copy/${zxEmp.id}' class='btn btn-warning' onclick="return alert('Unique field should not contain same value...!');"><i class='fa fa-clone'></i> <spring:message code='default.button.copy.label'/></a>             
                            <a href='${pageContext.request.contextPath}/zxEmp/delete/${zxEmp.id}' class='btn btn-danger pull-right' onclick="return confirm('Are you sure...? you want to delete this record...!');"><i class='fa fa-remove'></i> <spring:message code='delete.link.label'/></a>
                        </div>      <!--.box-footer-->
                    </div>      <!--.box .box-primary-->
                </section>      <!--.content-->
            </div>      <!--.content-wrapper-->
