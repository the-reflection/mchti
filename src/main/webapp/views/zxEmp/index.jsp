    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.list.label' text='List'/> Zx Emp</h1>
                <ul class='top-links'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>   
                    ...
                    <th class='center bold'><spring:message code='zxGender' text='Zx Gender'/></th>
                    ...
                    <th class='center bold'><spring:message code='sal' text='Sal'/></th>
                    <th class='center bold'><spring:message code='taxPaid' text='Tax Paid'/></th>
                    <th class='center bold'><spring:message code='email' text='Email'/></th>
                    <th class='center bold'><spring:message code='pin' text='Pin'/></th>
                    <th class='center bold'><spring:message code='webAddress' text='Web Address'/></th>
                    <th class='center bold'><spring:message code='docFile' text='Doc File'/></th>
                    ...
                    <th class='center bold'><spring:message code='zxDept' text='Zx Dept'/></th>
                    <th class='center bold'><spring:message code='zxDesg' text='Zx Desg'/></th>
                    <th class='center bold'><spring:message code='zxLookupBloodGroup' text='Zx Lookup Blood Group'/></th>
            ...
            <c:if test='${not empty zxEmps}'>
                <c:forEach items='${zxEmps}' var='zxEmp'  varStatus='loopStatus'>
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        ...
                        <td><c:url var='picFile' value='/zxEmp/getPhotoTumb/${zxEmp.picFile}'/>
<img alt='${zxEmp.picFile}' src='${picFile}'/></td>
...
<a target='_blank' href='${docFile}'>${zxEmp.docFile}</a></td>
                        ...
                        <td><c:out value='${zxEmp.zxLookupBloodGroup}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/zxEmp/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/zxEmp/delete/${zxEmp.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
