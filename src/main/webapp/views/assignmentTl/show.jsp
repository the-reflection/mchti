    ...
    <tiles:putAttribute name="body">
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            <section class="content-header"><!-- Content Header (Page header) -->
                <h1><spring:message code="default.button.show.label" text="Show"/> AssignmentTl</h1>
                <ul class="top-links">
                ...
                <span class="property-value" aria-labelledby="isOvertime">
                    <c:if test="${assignmentTl.isOvertime}"><spring:message code="default.boolean.true" text="YES"/></c:if><c:if test="${!assignmentTl.isOvertime}"><spring:message code="default.boolean.false" text="NO"/></c:if>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="${pageContext.request.contextPath}/assignmentTl/copy/${assignmentTl.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="copy.link.label"/></a>             
