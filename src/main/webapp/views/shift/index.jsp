                        ...
                        <td><c:out value='${shift.slNo}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/shift/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/shift/delete/${shift.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
