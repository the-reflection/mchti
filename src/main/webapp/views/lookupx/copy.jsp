...
<html>
    <head>
        <title><spring:message code="default.copy.label" text="Copy" arguments="All Lookup"/></title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
                <section class="content-header"><!-- Content Header (Page header) -->
                    <h1>
                        <!-- Page Header -->
                        <spring:message code="default.button.copy.label" text="Copy All Lookup"/>
                    ...
                    <ul class="top-links">
                        <ul class="top-links">
                            ...
                            <sec:access url="/lookupx/index">
                                <li><a href="${pageContext.request.contextPath}/lookupx/index" class="btn btn-block btn-primary btn-xs"><i class="fa fa-reorder"></i> <spring:message code="default.button.list.label" text="List"/></a></li>
                            </sec:access>
                        </ul>
                    </ul>
                ...
                <section class="content"><!-- Main content -->
                    <div class="box box-primary">
                        <form:form action="${pageContext.request.contextPath}/lookupx/copy/${lookupx.id}"  commandName="lookupx" method="POST">
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                <div class="btn-group">
                                    ...
                                    <input type="submit" class="btn btn-warning" value="<spring:message code="default.button.copy.label" text="Copy"/>"/>
                                </div>
                            </div>
                        </form:form>
                    </div>
