                        ...
                        <td><c:out value='${authRequestMap.url}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/authRequestMap/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/authRequestMap/delete/${authRequestMap.id}' onclick='return confirm('Are you sure to delete?');'>
