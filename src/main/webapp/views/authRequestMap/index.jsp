                    ...
                    <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                        ...
                        <td><c:out value='${authRequestMap.url}'/></td>
                           ...
                           <td class='center action'>
                            <ul class='top-links'>
                            <sec:access url='/authRequestMap/show'>
                                <li>
                                <a class='btn btn-block btn-info btn-xs' href='${pageContext.request.contextPath}/authRequestMap/show/${authRequestMap.id}'>
                                    <i class='fa fa-info-circle'></i> <spring:message code='show.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/authRequestMap/edit'>
                                <li>
                                <a class='btn btn-block btn-primary btn-xs' href='${pageContext.request.contextPath}/authRequestMap/edit/${authRequestMap.id}'>
                                    <i class='fa fa-edit'></i> <spring:message code='edit.link.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/authRequestMap/copy'>
                                <li>
                                <a class='btn btn-block btn-warning btn-xs' href='${pageContext.request.contextPath}/authRequestMap/copy/${authRequestMap.id}'>
                                    <i class='fa fa-clone' aria-hidden='true'></i> <spring:message code='default.button.copy.label'/>
                                </a>
                                </li>
                            </sec:access>
                            <sec:access url='/authRequestMap/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/authRequestMap/delete/${authRequestMap.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
