    ...
    <tiles:putAttribute name="body">
        ...
        <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
            <section class="content-header"><!-- Content Header (Page header) -->
                <h1><spring:message code="default.button.show.label" text="Show"/> GeneralHoliday</h1>
                <ul class="top-links">
            ...
            <section class="content"><!-- Main content -->
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="${pageContext.request.contextPath}/generalHoliday/copy/${generalHoliday.id}" class="btn btn-warning"><i class="fa fa-clone"></i> <spring:message code="copy.link.label"/></a>             
