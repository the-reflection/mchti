    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.list.label' text='List'/> General Holiday</h1>
                <ul class='top-links'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>   
                    ...
                    <th class='center bold'><spring:message code='onDay' text='On Day'/></th>
                    <th class='center bold'><spring:message code='onMonth' text='On Month'/></th>
                        ...
                        <td><c:out value='${generalHoliday.remarks}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/generalHoliday/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/generalHoliday/delete/${generalHoliday.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
