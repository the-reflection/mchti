    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> General Holiday</h1>
                <ul class='top-links'>
                    <sec:access url='/generalHoliday/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/generalHoliday/index' class='btn btn-block btn-vimeo btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-generalHoliday' class='box box-primary' role='main'>
                    <form:form action='${pageContext.request.contextPath}/generalHoliday/create'  commandName='generalHoliday' method='POST'>
                        <div class='box-body'>
