    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.list.label' text='List'/> Zx Lookup</h1>
                <ul class='top-links'>
            ...
            <section class='content'><!-- Main content -->
                <div class='box box-primary'>   
                    ...
                    <th class='center bold'><spring:message code='zxLookupKeyword' text='Zx Lookup Keyword'/></th>
                        ...
                        <td><c:out value='${zxLookup.zxLookupKeyword}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/zxLookup/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/zxLookup/delete/${zxLookup.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
