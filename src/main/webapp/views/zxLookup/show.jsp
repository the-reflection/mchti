                ...
                <span class='property-value' aria-labelledby='zxLookupKeyword'>
                    <c:out value='${zxLookup.zxLookupKeyword}'/>
                        ...
                        <div class='box-footer'>
                            ...
                            <a href='${pageContext.request.contextPath}/zxLookup/copy/${zxLookup.id}' class='btn btn-warning'><i class='fa fa-clone'></i> <spring:message code='default.button.copy.label'/></a>             
