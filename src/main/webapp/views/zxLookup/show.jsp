            ...
            <section class="content"><!-- Main content -->
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="${pageContext.request.contextPath}/zxLookup/delete/${zxLookup.id}" class="btn btn-danger confirm-delete"><i class="fa fa-remove"></i> <spring:message code="delete.link.label"/></a>
                    </div>      <!--.box-footer-->
                </div>      <!--.box .box-primary-->
            </section>      <!--.content-->
        </div>      <!--.content-wrapper-->
