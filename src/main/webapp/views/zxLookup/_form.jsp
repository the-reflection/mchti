...
<fieldset>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <form:textarea class="form-control" path="titleBng" type="text" size="30" maxlength="500" rows="1" cols="40"/>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <form:textarea class="form-control" path="remarks" type="text" size="30" maxlength="500" rows="1" cols="40"/>
