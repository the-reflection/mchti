    ...
    <tiles:putAttribute name='body'>
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.create.label' text='Create'/> Company</h1>
                <ul class='top-links'>
                    <sec:access url='/company/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/company/index' class='btn btn-block btn-vimeo btn-xs'>
            ...
            <section class='content'><!-- Main content -->
                <div id='create-company' class='box box-primary' role='main'>
                    <form:form action='${pageContext.request.contextPath}/company/create' enctype='multipart/form-data' commandName='company' method='POST'>
                        <div class='box-body'>
