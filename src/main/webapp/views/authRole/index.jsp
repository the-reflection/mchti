                        ...
                        <td><c:out value='${authRole.authority}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/authRole/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/authRole/delete/${authRole.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
