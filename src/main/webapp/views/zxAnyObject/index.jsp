                        ...
                        <td><c:out value='${zxAnyObject.slNo}'/></td>
                           ...
                           <td class='center action'>
                            ...
                            <sec:access url='/zxAnyObject/delete'>
                                <li>
                                <a class='btn btn-block btn-danger btn-xs' href='${pageContext.request.contextPath}/zxAnyObject/delete/${zxAnyObject.id}' onclick="return confirm('Are you sure...? you want to delete this record...!');">
