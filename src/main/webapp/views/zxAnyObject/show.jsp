    ...
    <tiles:putAttribute name='body'>
        ...
        <div class='content-wrapper'><!-- Content Wrapper. Contains page content -->
            <section class='content-header'><!-- Content Header (Page header) -->
                <h1><spring:message code='default.button.show.label' text='Show'/> Zx Any Object</h1>
                <ul class='top-links'>
                    ...
                    <sec:access url='/zxAnyObject/index'>
                        <li>
                            <a href='${pageContext.request.contextPath}/zxAnyObject/index' class='btn btn-block btn-info btn-xs'><i class='fa fa-reorder'></i> <spring:message code='default.button.list.label' text='List'/></a>
                        </li>
                    </sec:access>
                </ul>
        ...
        <c:if test='${zxAnyObject.startDate!=null}'>
            <li class='fieldcontain first_item'>
                <span id='title' class='property-label'>
                    <spring:message code='startDate' text='Start Date'/>: 
                </span>
                <span class='property-value' aria-labelledby='startDate'>
                    <fmt:formatDate value='${zxAnyObject.startDate}' type='date' pattern='dd/MM/yyyy'/>
                </span>
            </li>
        </c:if>
                ...
                <span class='property-value' aria-labelledby='slNo'>
                    <c:out value='${zxAnyObject.slNo}'/>
                        ...
                        <div class='box-footer'>
                            <a href='${pageContext.request.contextPath}/zxAnyObject/edit/${zxAnyObject.id}' class='btn btn-primary'><i class='fa fa-edit'></i> <spring:message code='edit.link.label'/></a> 
                            <a href='${pageContext.request.contextPath}/zxAnyObject/copy/${zxAnyObject.id}' class='btn btn-warning' onclick="return alert('Unique field should not contain same value...!');"><i class='fa fa-clone'></i> <spring:message code='default.button.copy.label'/></a>             
                            <a href='${pageContext.request.contextPath}/zxAnyObject/delete/${zxAnyObject.id}' class='btn btn-danger pull-right' onclick="return confirm('Are you sure...? you want to delete this record...!');"><i class='fa fa-remove'></i> <spring:message code='delete.link.label'/></a>
                        </div>      <!--.box-footer-->
                    </div>      <!--.box .box-primary-->
                </section>      <!--.content-->
            </div>      <!--.content-wrapper-->
